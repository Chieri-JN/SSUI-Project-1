...
var FittsTestUI = /** @class */ (function (_super) {
    ...
    FittsTestUI.prototype.configure = function (newState) {
        ...
        switch (this.currentState) {
            ...
            case 'begin_trial':
                this.theReticle.visible = true;
                this.theBackground.msg4 = "Trial #".concat(this.trialCount, " of ").concat(this.MAX_TRIALS);
...
var BackgroundDisplay = /** @class */ (function (_super) {
    ...
    Object.defineProperty(BackgroundDisplay.prototype, "msg4", {
        get: function () { return this._msg4; },
        set: function (v) { this._msg4 = v; this.declareDamaged(); },
        enumerable: false,
        configurable: true
    });
    Object.defineProperty(BackgroundDisplay.prototype, "msg5", {
        get: function () { return this._msg4; },
        set: function (v) { this._msg4 = v; this.declareDamaged(); },
        enumerable: false,
        configurable: true
